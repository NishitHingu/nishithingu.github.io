...
const StyledHighlight = styled.span<StyledHighlightProps>`
  ...
  ${media.thone`
    ...
    transform: translateX(
      ${(props: any) => (props.activeTabId > 0 ? props.activeTabId * theme.tabWidth : 0)}px
    );
    margin-left: 50px;
  `};
  ${media.phablet`
            ...
            return (
              <StyledTabContent
                ...
                <StyledJobTitle>
                  ...
                  <StyledGreenText>
                    <span>&nbsp;@&nbsp;</span>
                    <a href={node.url} target="_blank" rel="nofollow noopener noreferrer">
                      {node.company}
                    </a>
                  </StyledGreenText>
                </StyledJobTitle>
                ...
                <StyledJobDetails style={{margin: "22px 0 0 0"}}>
                  <StyledGreenText>
                    Skills Aquired: {node.skills}
                  </StyledGreenText>
                </StyledJobDetails>
              </StyledTabContent>
            );
